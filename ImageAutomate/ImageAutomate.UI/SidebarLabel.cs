...
/// <summary>
/// Label control that adapts its appearance based on sidebar expansion state.
/// </summary>
public class SidebarLabel : Label, ISidebarItem
{
    ...
    /// <summary>
    /// Called by SidebarControl to notify the label of state changes.
